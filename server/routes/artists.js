...
var CLASS = 'artists'; //Parse Class (table name)
var CLASS_T = 'artists_t'; //Parse Class (table name)

var idField = 'objectId'; //Parse Key field name
var idFieldArtist = 'artistId'; //Parse Key field name
...
router.route('/artists/:id/texts')
  //read all texts of given ArtistID
  .get(function (req, res) {
    var params = {where: {artistId: req.params.id}};
  ...
  .post(function (req, res) {
    _.extend(req.body, {}[idFieldArtist] = req.params.id);
